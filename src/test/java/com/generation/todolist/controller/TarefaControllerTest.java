...
public class TarefaControllerTest {
	...
	public void deveListarApenasUmaTarefa() {
		...
		Tarefa tarefa = tarefaRepository.save(new Tarefa(0L, "Tarefa 02", "Tarefa numero 2", 
                                    "Maria", LocalDate.now(), true));
	
		ResponseEntity<String> resposta = testRestTemplate
				.exchange("/tarefas/" + tarefa.getId(), HttpMethod.GET, null, String.class);
	...
	public void deveListarTodasAsTarefas() {
		...
		Tarefa tarefa = tarefaRepository.save(new Tarefa(0L, "Tarefa 03", "Tarefa numero 3", "Brenda", LocalDate.now(), true));
	...
	public void deveBuscarTarefaPorNome() {
		
		Tarefa tarefa = tarefaRepository.save(new Tarefa(0L, "Tarefa 04", "Tarefa numero 4", "Marlene", LocalDate.now(), true));
		
		ResponseEntity<String> resposta = testRestTemplate
				.exchange("/tarefas/nome/tarefa", HttpMethod.GET, null, String.class);
	...
	public void deveAtualizarUmaTarefa() {
		...
		Tarefa tarefa = tarefaRepository.save(new Tarefa(0L, "Tarefa 05", "Tarefa numero 5", "Aurinha", LocalDate.now(), true));
	
		Tarefa tarefaAtualizar = tarefaRepository.save(new Tarefa(tarefa.getId(), "Tarefa 05", "Tarefa numero 5 - ATUALIZADA!!!", "Aurinha", LocalDate.now(), true));
	
		HttpEntity<Tarefa> corpoRequisicao = new HttpEntity<Tarefa>(tarefaAtualizar);
	...
	@Test
	@DisplayName("Apagar em Tarefa")
	public void deveApagarUmaTarefa() {
		
		Tarefa tarefa = tarefaRepository.save(new Tarefa(0L, "Tarefa 06", "Tarefa numero 6", "Everaldo", LocalDate.now(), true));
